...
<html lang="ar"  dir="rtl" >
  ...
  <body class="custom-scrollbar" id="student">
...
<header class="s" id="nav">
      ...
      <i class="fa-solid fa-bars"></i>
        ...
        <li class="nav-item">
          <a href="student-c1.php" class="nav-link">التسجيل</a>
        </li>
        <li class="nav-item">
    ...
    <section id="container1">
      ...
      <div class="container">
        <div class="row">
      <div class="left-div ps-xl-5 ps-lg-5 mt-3 mb-2 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 ">
              <img src="../img/download (1).jpg" class="col-md-5 logo"> 
      </div>
      <div class="right-div  ps-xl-5 mt-3 mb-2 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 ">
          <h2 lang="ar">ماذا نقدم؟</h2>
          <p lang="ar" > مركز تعليمي تابع لكلية التجارة منوط به تقديم خدمات التدريب في جميع المجالات وبخاصة في مجال الحاسب الآلي حيث يعتبر مركز الحاسب الآلي التابع للوحدة أحد أهم مراكز التدريب ، هذا بخلاف الدورات المختلفة في جميع أنواع الدورات التي يتطلبها سوق العمل  </p>
</div>
</div>
</div>
  </div>
