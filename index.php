...
<html lang="ar"  dir="rtl">
  <head>
    ...
    <title>مركز الحاسب الآلى - كلية تجارة</title>
...
<!-- nav section -->
  <header class="s" id="nav">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a href="page\student.php" class="nav-link">طالب</a>
        </li>
        <li class="nav-item">
            <a href="page\employee-login.php" class="nav-link">موظف</a>
        </li>  
            </ul>
          </div>
        </div>
  ...
  <div class="container">
      ...
      <div class="container text-center">
        ...
        <div class="card col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="width: 18rem;">
        <i class="fa-solid fa-graduation-cap"></i>
        <a href="page\student.php">
        <div class="card-body">
        <h2 class="h2 pt-2 pb-2 mb-2 fw-bold">طالب</h2>
        <p class="card-text ">“للمزيد من المعلومات عن الدورات المتاحة و مواعيد الامتحانات .“</p>
        </div>
        </a>
        </div>
        ...
        <a href="page\employee-login.php"> 
        <div class="card-body">
        <h2 class="h2 pt-2 pb-2 mb-2 fw-bold">موظف</h2>
        <p class="card-text ">“للموظفين و العاملين بمركز الحاسب الآلى  .“</p>
        </div>
        </a> 
        </div>
