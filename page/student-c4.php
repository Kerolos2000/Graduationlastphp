...
<html lang="ar"  >
  ...
  <body class="custom-scrollbar" id="student-c4">
    <!-- nav section -->
    <header dir="rtl" class="s" id="nav">
      ...
      <i class="fa-solid fa-bars"></i>
        ...
        <li class="nav-item">
            <a href="student-c4.php" class="nav-link active">تواصل معنا</a>
        </li>
    ...
    <section class="container1">
      ...
      <h1 lang="ar">تواصل معنا</h1>
      <p lang="ar"> ...إذا واجهتك اى مشكلة لا تتردد فى التواصل معنا </p>
      <form>
        <div class="contant">
          <div class="leftdiv">
                    <input type="text"  
            ...
            <textarea lang="ar" placeholder="...اكتب رسالتك" required></textarea> 
