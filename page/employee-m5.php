...
<body class="custom-scrollbar" id="employee-m5">
    <!-- nav section -->
...
<section id="manage-course">
    <div class="container text-center">
        <h2 class="fw-bold pt-5" style="color: #364f6b;">
                ادارة مواعيد الامتحانات
        </h2>
        <h6 class="text-black-50 mt-2 mb-4" >
                للاعلان عن المواعيد الجديدة للامتحانات بمركز الحاسب الآلى
        </h6>
        <main>
            <div class="form">
                <div class="form-outline form-white mb-3 ">
                
                    <textarea spellcheck="false" id="typeTextareaX"  required></textarea>
                </div>
                <div>
                    <button button value="submit" class="btn btn-outline-dark  mouse-cursor-1 text-center mt-3" name="submit" data-testid="royal_signup_button" type="submit">نشر الميعاد</button>
                </div>
                </div>
                <div class="todos"></div>
        </main>
