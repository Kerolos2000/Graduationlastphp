...
<html  lang="ar"  dir="rtl">
  ...
  <body class="custom-scrollbar" id="student-c1">
    <!-- nav section -->
        ...
        <div class="card text-black-50" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="text-black-50 mb-5 mt-3">برجاء تسجيل البريد و كلمة السر !</p>
              <form action="student-c2.php" class=" needs-validation" novalidate>
              ...
              <div class="mt-3">
                <a href="../page/studentForm.php">انشاء حساب</a>
              </div>
              </form>
            </div>
          </div>
